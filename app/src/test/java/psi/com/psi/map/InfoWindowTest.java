...
public class InfoWindowTest {
    ...
    public void testInfoWindow(){
        ...
        Psi psi = new Gson().fromJson(response,Psi.class);

        View view =  LayoutInflater.from(activity.getApplicationContext()).inflate(R.layout.psi_reading, null);
        activity.fillInfoWindow(
            view,
                psi.items.get(0).readings.o3SubIndex.north,
                psi.items.get(0).readings.pm10TwentyFourHourly.north,
                psi.items.get(0).readings.pm10SubIndex.north,
                psi.items.get(0).readings.coSubIndex.north,
                psi.items.get(0).readings.pm25TwentyFourHourly.north,
                psi.items.get(0).readings.so2SubIndex.north,
                psi.items.get(0).readings.coEightHourMax.north,
                psi.items.get(0).readings.no2OneHourMax.north,
                psi.items.get(0).readings.so2TwentyFourHourly.north,
                psi.items.get(0).readings.pm25SubIndex.north,
                psi.items.get(0).readings.psiTwentyFourHourly.north,
                psi.items.get(0).readings.o3EightHourMax.north
        );

        assertEquals(((TextView)view.findViewById(R.id.o3_sub_index)).getText().toString(),
                String.valueOf(psi.items.get(0).readings.o3SubIndex.north));

        assertEquals(((TextView)view.findViewById(R.id.pm10_twenty_four_hourly)).getText().toString(),
                String.valueOf(psi.items.get(0).readings.pm10TwentyFourHourly.north));

        assertEquals(((TextView)view.findViewById(R.id.pm10_sub_index)).getText().toString(),
                String.valueOf(psi.items.get(0).readings.pm10SubIndex.north));

        assertEquals(((TextView)view.findViewById(R.id.co_sub_index)).getText().toString(),
                String.valueOf(psi.items.get(0).readings.coSubIndex.north));

        assertEquals(((TextView)view.findViewById(R.id.pm25_twenty_four_hourly)).getText().toString(),
                String.valueOf(psi.items.get(0).readings.pm25TwentyFourHourly.north));

        assertEquals(((TextView)view.findViewById(R.id.so2_sub_index)).getText().toString(),
                String.valueOf(psi.items.get(0).readings.so2SubIndex.north));

        assertEquals(((TextView)view.findViewById(R.id.co_eight_hour_max)).getText().toString(),
                String.valueOf(psi.items.get(0).readings.coEightHourMax.north));

        assertEquals(((TextView)view.findViewById(R.id.no2_one_hour_max)).getText().toString(),
                String.valueOf(psi.items.get(0).readings.no2OneHourMax.north));

        assertEquals(((TextView)view.findViewById(R.id.so2_twenty_four_hourly)).getText().toString(),
                String.valueOf(psi.items.get(0).readings.so2TwentyFourHourly.north));

        assertEquals(((TextView)view.findViewById(R.id.pm25_sub_index)).getText().toString(),
                String.valueOf(psi.items.get(0).readings.pm25SubIndex.north));

        assertEquals(((TextView)view.findViewById(R.id.psi_twenty_four_hourly)).getText().toString(),
                String.valueOf(psi.items.get(0).readings.psiTwentyFourHourly.north));

        assertEquals(((TextView)view.findViewById(R.id.o3_eight_hour_max)).getText().toString(),
                String.valueOf(psi.items.get(0).readings.o3EightHourMax.north));
    }
}
